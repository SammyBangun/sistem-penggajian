						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">Informasi Potongan</th>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td class="">
											<p>Nama: <b><?php echo $row['deduction'] ?></b></p>
										...
										<td class="text-center">
											...
											<button class="btn btn-sm btn-danger delete_deductions" type="button" data-id="<?php echo $row['id'] ?>">Hapus</button>
										</td>
									</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.delete_deductions').click(function() {
		_conf("Apakah anda yakin ingin menghapusnya ?", "delete_deductions", [$(this).attr('data-id')])
	})
