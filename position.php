					...
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Departmen</label>
								...
								?>
									<tr>
										...
										<td class="text-center">
											...
											<button class="btn btn-sm btn-danger delete_position" type="button" data-id="<?php echo $row['id'] ?>">Hapus</button>
										</td>
									</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.delete_position').click(function() {
		_conf("Apakah anda yakin ingin menghapusnya ?", "delete_position", [$(this).attr('data-id')])
	})
