						...
						<div class="card-footer">
							<div class="row">
								<div class="col-md-12">
									...
									<button class="btn btn-sm btn-default col-sm-3" type="button" onclick="_reset()"> Batal</button>
								</div>
							</div>
						</div>
					</div>
						...
						<table class="table table-bordered table-hover">
							<thead>
								<tr>
									...
									<th class="text-center">Informasi Tunjangan</th>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td class="">
											<p>Nama: <b><?php echo $row['allowance'] ?></b></p>
											<p class="truncate"><small>Deskripsi: <b><?php echo $row['description'] ?></b></small></p>
										</td>
										<td class="text-center">
											...
											<button class="btn btn-sm btn-danger delete_allowances" type="button" data-id="<?php echo $row['id'] ?>">Hapus</button>
										</td>
									</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.delete_allowances').click(function() {
		_conf("Apakah anda yakin ingin menghapusnya?", "delete_allowances", [$(this).attr('data-id')])
	})
