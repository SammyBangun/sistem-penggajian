								...
								?>
									<tr>
										...
										<td class="text-center">
											...
											<button class="btn btn-sm btn-danger delete_department" type="button" data-id="<?php echo $row['id'] ?>">Hapus</button>
										</td>
									</tr>
								<?php endwhile; ?>
							</tbody>
...
<script>
	...
	$('.delete_department').click(function() {
		_conf("Apakah anda yakin ingin menghapusnya?", "delete_department", [$(this).attr('data-id')])
	})
