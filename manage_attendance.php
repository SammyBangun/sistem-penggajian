			...
			<div class="row form-group">
				<div class="col-md-4">
					...
					<select id="employee_id" class="borwser-default select2">
						<option value=""></option>
						<?php
						$employee = $conn->query("SELECT *,firstname as ename FROM employee order by firstname asc");
				...
				<div class="col-md-3">
					...
					<select id="type" class="borwser-default custom-select">
						<option value="1">Waktu Masuk</option>
						<option value="2">Waktu Selesai</option>
		...
		$('#employee-attendance').submit(function(e) {
			...
			$.ajax({
				...
				success: function(resp) {
					if (resp == 1) {
						alert_toast("Data kehadiran berhasil disimpan", "success");
						setTimeout(function() {
							location.reload()
						}, 1000)
					}
